...
public:
	...
	Player(unsigned int id, int x, int y, Team team) :id(id), coordinate(Coordinate(x, y)), team(team),HP(0){}
	Player(unsigned int id, int x, int y, Team team, int hp) :id(id), coordinate(Coordinate(x, y)), team(team), HP(hp) {}
